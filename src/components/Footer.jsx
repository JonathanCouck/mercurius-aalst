      ...
      <div className="p-4 mx-auto max-w-lg">
        <div className="flex mx-auto px-4">
            ...
            <ul className="items-center ml-auto space-y-5 my-auto">
                <li title='Facebook'>
                  <a href="https://www.facebook.com/groups/172470292809076/" target="_blank" rel="noreferrer" className='flex hover:bg-lgreen p-2 rounded-lg'>
                ...
                <li title='TikTok'>
                  <a href="https://www.tiktok.com/@mercurius.aalst/" target="_blank" rel="noreferrer" className='flex hover:bg-lgreen p-2 rounded-lg'>
                    <FaTiktok color='white' size={30} />
                    <div className='my-auto ml-5'>TikTok</div>
                  </a>
                </li>
                <li title='Instagram'>
                  <a href="https://www.instagram.com/mercurius.aalst/" target="_blank" rel="noreferrer" className='flex hover:bg-lgreen p-2 rounded-lg'>
                    <FaInstagram color='white' size={30} />
                    <div className='my-auto ml-5'>Instagram</div>
                  </a>
                </li>
                <li title='E-mail'>
                  <a href="mailto:mercurius@hogent.be" target="_blank" rel="noreferrer" className='flex hover:bg-lgreen p-2 rounded-lg'>
