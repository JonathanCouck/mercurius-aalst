  ...
  return (
    <div className='my-10 space-y-10'>
      ...
      <div className='mx-5 md:mx-auto my-10'>
        <span className='text-green text-subtitle font-semibold'>Komende activiteiten</span>
      ...
      <div className='mx-5 md:mx-auto my-10'>
        <span className='text-green text-subtitle font-semibold'>Voorgaande activiteiten</span>
        <div className='md:grid md:grid-cols-2 max-w-4xl mx-auto'>
          {
            voorgaande.length===0?
