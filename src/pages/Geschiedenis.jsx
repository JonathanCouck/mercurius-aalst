    ...
    <div>
      ...
      <div className='my-10 space-y-10'>
        <div className='mx-5 my-10 sm:mx-auto sm:max-w-xl sm:m-0 space-y-4'>
          ...
          <p className='text-justify'>Het in 1948 ontstane Mercurius is de oudste nog bestaande studentenclub van Aalst. In de pas opgerichte Rijkshogere Handelsschool werd door toenmalig directeur Reychler Studentenbond Mercurius boven de doopvont gehouden.\nEr werd onder andere toneel gespeeld en een bibliotheek beheerd. Er was ook het studentenblad Kwik. Het is duidelijk dat er sindsdien veel veranderd is. In de zeventig jarige geschiedenis heeft de club tweemaal een onderbreking gekend van enkele jaren.</p>
        ...
        <div className='mx-5 my-10 sm:mx-auto sm:max-w-xl sm:m-0 space-y-4'>
          ...
          <p className='text-justify'>Mercurius was de Romeinse god van de handelaren (ook wel van de dieven en bedriegers). Zijn Griekse tegenhanger was Hermes, net zoals nu de Gentse tegenhanger van Mercurius heet.</p>
